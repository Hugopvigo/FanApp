...
val PurpleTextMuted      = Color(0xFFB0A1C8)
val PurpleTextDim        = Color(0xFF7C6B94)
val PurplePrimary        = Color(0xFFC4A7FF)
val PurplePrimarySoft    = Color(0xFF5A3D8A)
val PurpleAccent         = Color(0xFFF5A3C4)
val PurpleAccentSoft     = Color(0xFF7A3A5A)
val PurpleBorder         = Color(0x24B794F6) // rgba(183,148,246,0.14)
val PurpleBorderStrong   = Color(0x42B794F6) // rgba(183,148,246,0.26)
val PurpleStatusWant     = Color(0xFFC4A7FF)
val PurpleStatusProg     = Color(0xFFF5A3C4)
val PurpleStatusDone     = Color(0xFF7EEAB3)
val PurpleStatusDropped  = Color(0xFF8A7595)
val PurpleStatusFav      = Color(0xFFF5A3C4)
val PurpleSparkle        = Color(0xFFE0BCFF)
val PurpleNavBar         = Color(0xFF140E20)
val PurpleSurfContainer  = Color(0xFF1C1230)
...
val DarkTextMuted        = Color(0xFF9097A3)
val DarkTextDim          = Color(0xFF5B626D)
val DarkPrimary          = Color(0xFF6D92FF)
val DarkPrimarySoft      = Color(0xFF1F2A44)
val DarkAccent           = Color(0xFFE4B066)
val DarkAccentSoft       = Color(0xFF3A2D18)
val DarkBorder           = Color(0x14FFFFFF) // rgba(255,255,255,0.08)
val DarkBorderStrong     = Color(0x29FFFFFF) // rgba(255,255,255,0.16)
val DarkStatusWant       = Color(0xFF6D92FF)
val DarkStatusProg       = Color(0xFFE4B066)
val DarkStatusDone       = Color(0xFF5CC89E)
val DarkStatusDropped    = Color(0xFF6B6B75)
val DarkStatusFav        = Color(0xFFE4B066)
val DarkSparkle          = Color(0xFF6D92FF)
val DarkNavBar           = Color(0xFF0A0B0E)
val DarkSurfContainer    = Color(0xFF12141A)
val DarkSurfVariant      = Color(0xFF1C2030)
